...
STELLAR_INFO dict in `stellar_predictor/data/known_systems.py` contains stellar mass/radius/Teff for each system. Planet data for exoplanet systems is sourced from NASA Exoplanet Archive; Solar System data from JPL J2000 orbital elements.
